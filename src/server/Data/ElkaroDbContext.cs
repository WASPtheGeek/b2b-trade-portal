...
namespace Elkaro.Server.Data;

public partial class ElkaroDbContext : DbContext
{
    public ElkaroDbContext()
    {
    }

    public ElkaroDbContext(DbContextOptions<ElkaroDbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<PromotionClient> PromotionClients { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrderAddress>(entity =>
        {
            ...
            entity.HasOne<UserAddress>().WithMany()
        ...
        modelBuilder.Entity<OrderItem>(entity =>
        {
            ...
            entity.Property(e => e.OrderId).HasColumnName("order_id");
            entity.Property(e => e.PackagingUnitUsed)
                .HasConversion<short>()
                .HasColumnName("packaging_unit_used");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasOne(d => d.VatRate).WithMany()
        ...
        modelBuilder.Entity<ProductAttributeValue>(entity =>
        {
            ...
            entity.HasOne(d => d.AttributeDefinition).WithMany(p => p.Values)
        ...
        {
            entity.HasKey(e => new { e.PromotionId, e.CategoryId }).HasName("promotion_categories_pkey");
            ...
            entity.HasOne(d => d.Promotion).WithMany(p => p.Categories)
        ...
        {
            entity.HasKey(e => new { e.PromotionId, e.BrandId }).HasName("promotion_brands_pkey");

            entity.ToTable("promotion_brands");

            entity.Property(e => e.PromotionId).HasColumnName("promotion_id");
            entity.Property(e => e.BrandId).HasColumnName("brand_id");

            entity.HasOne(d => d.Promotion).WithMany(p => p.Brands)
                .HasForeignKey(d => d.PromotionId)
        ...
        modelBuilder.Entity<PromotionClient>(entity =>
        {
            entity.HasKey(e => new { e.PromotionId, e.UserId }).HasName("promotion_clients_pkey");

            entity.ToTable("promotion_clients");

            entity.HasIndex(e => e.UserId, "idx_promotion_clients_user");

            entity.Property(e => e.PromotionId).HasColumnName("promotion_id");
            entity.Property(e => e.UserId).HasColumnName("user_id");

            entity.HasOne(d => d.Promotion).WithMany(p => p.Clients)
                .HasForeignKey(d => d.PromotionId)
