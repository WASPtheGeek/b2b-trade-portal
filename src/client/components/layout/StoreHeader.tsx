...
export function StoreHeader({
  ...
  const accountAction = user ? (
    ...
    <Button variant="primary" pill size="md" icon="user" onClick={ onLogin } className="w-control-md px-0 lg:w-auto lg:px-4">
      <span className="hidden lg:inline">{ labels.account }</span>
    </Button>
  );
